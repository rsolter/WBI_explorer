...
# function to calculate multiple metrics from ts values in clusters
  # RAW - actual time series values
  # YOY - %  year-over-year change in the series
  # CUM - % change from first value in the series 
